Bu proje, **Bun** runtime ve **TypeScript** kullanılarak geliştirilmiş, Binance WebSocket API üzerinden anlık Bitcoin (BTC/USD) fiyatlarını çeken yüksek performanslı bir terminal uygulamasıdır.
